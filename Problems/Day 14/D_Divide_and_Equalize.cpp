...
/*---------Given Data---------
    1. array of size 'n' made of positive integers
    2. operation
        a. choose two distinct indices i and j
        b. choose a divisor 'x' of ai
        c. replace ai by ai / x and aj by aj * x
*/

/*---------Objective---------
    Determine if all the numbers can be made same after any number of operations
*/
...
/*---------Observations---------
    1. after an operation, the product of all the numbers does not change, only one factor moves from one number to another
*/
...
string solve() {
    ...
    // count the frequency of the prime factors throughout the array
    ...
    // if all the prime factors have their individual frequency that is divisible by 'n' then we can equalize the numbers
    fe(factor, prime_factors)
        if(factor.second % n != 0) return "NO";
